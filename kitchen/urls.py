...
from kitchen.views import (
    ...
    DishUpdateView,
    CookListView,
    CookDetailView, CookYearsOfExperienceUpdateView,
)
...
urlpatterns = [
    ...
    path("dish-types/<int:pk>/create-dish/", dish_create_view, name="dish-create"),
    path("dish/<int:pk>/delete/", dish_delete_view, name="dish-delete"),
